...
{
    public class SmoothShake3D : MonoBehaviour
    {
        /*
        ...
        */
        ...
        [SerializeField] float zPositionFrequency = 0f;
        [Tooltip("Generally between 0 and 1")]
        [SerializeField] float rotationIntensity = 0.1f;
        [SerializeField] float xRotationFrequency = 23f;
        [SerializeField] float yRotationFrequency = 25f;
        [SerializeField] float zRotationFrequency = 27f;
        ...
        float savezPositionFrequency = 0f;
        float saveRotationIntensity = 0.1f;
        float savexRotationFrequency = 23f;
        float saveyRotationFrequency = 25f;
        float savezRotationFrequency = 27f;
        ...
        private void Awake()
        {
            ...
            savezPositionFrequency = zPositionFrequency;
            saveRotationIntensity = rotationIntensity;
            savexRotationFrequency = xRotationFrequency;
            saveyRotationFrequency = yRotationFrequency;
            savezRotationFrequency = zRotationFrequency;
        }
        ...
        public void CustomShakeFadeIn(float newFadeInDuration, float newAdditionalShakeDuration, bool shakeUntilStopped, float customPositionIntensity, float customXFrequency, float customYFrequency, float customZFrequency, float customRotationIntensity, float customXRotationFrequency, float customYRotationFrequency, float customZRotationFrequency)
        {
            fadeIn = true;
            fadeOut = false;
            ...
            zPositionFrequency = customZFrequency;
            rotationIntensity = customRotationIntensity;
            xRotationFrequency = customXRotationFrequency;
            yRotationFrequency = customYRotationFrequency;
            zRotationFrequency = customZRotationFrequency;
        ...
        public void CustomShakeFadeOut(float newFadeOutDuration, float newAdditionalShakeDuration, float customPositionIntensity, float customXFrequency, float customYFrequency, float customZFrequency, float customRotationIntensity, float customXRotationFrequency, float customYRotationFrequency, float customZRotationFrequency)
        {
            fadeIn = false;
            fadeOut = true;
        ...
        public void SimpleShakeFadeInOut(float newFadeInDuration, float newFadeOutDuration, float customPositionIntensity, float customRotationIntensity)
        {
            fadeIn = true;
            fadeOut = true;
        ...
        public void CustomShakeFadeInOut(float newFadeInDuration, float newFadeOutDuration, float newAdditionalShakeDuration, float customPositionIntensity, float customXFrequency, float customYFrequency, float customZFrequency, float customRotationIntensity, float customXRotationFrequency, float customYRotationFrequency, float customZRotationFrequency)
        {
            fadeIn = true;
            fadeOut = true;
        ...
        private void Update()
        {
            if (shakeStarted)
            {
                ...
                float z = startPosition.z + Mathf.Sin(Time.time * zPositionFrequency) * newPositionIntensity;
                transform.localPosition = new Vector3(x, y, z);

                float rotShakeX = Mathf.Sin(Time.time * xRotationFrequency) * newRotationIntensity;
                float rotShakeY = Mathf.Sin(Time.time * yRotationFrequency) * newRotationIntensity;
                float rotShakeZ = Mathf.Sin(Time.time * zRotationFrequency) * newRotationIntensity;
        ...
        private void returnDefaultValues()
        {
            ...
            zPositionFrequency = savezPositionFrequency;
            rotationIntensity = saveRotationIntensity;
            xRotationFrequency = savexRotationFrequency;
            yRotationFrequency = saveyRotationFrequency;
            zRotationFrequency = savezRotationFrequency;
        }
